...
白背景・グレースケール・レベル補正済みの幅2,000px、JPEG品質0.8の画像へ変換します。
基本1〜6ページに加え、指定時は評価書の開始ページから6ページを追加し、最大12枚・
JSONペイロード3.5MB以内に制限します。容量超過時は品質を維持したまま幅1,700px、
1,500pxの順に再生成し、それでも超える場合はページ数を減らすよう案内します。
AIへ送信する前に1枚目のプレビューを表示し、クリックすると原寸で確認できます。
